...
public class Mutagen extends JFrame implements ActionListener{
...
JLabel l1 = new JLabel ("Sekvenca 1:",SwingConstants.LEFT); 
JLabel l2 = new JLabel ("Sekvenca 2:",SwingConstants.LEFT); 
JLabel l3 = new JLabel ("Sinonim sq:",SwingConstants.LEFT);
JLabel l3a= new JLabel ("Mutiran sq:",SwingConstants.LEFT);
JLabel l4 = new JLabel ("Br pokušaja:\t",SwingConstants.LEFT);
JLabel l5 = new JLabel ("Br usvojenih:\t",SwingConstants.LEFT);//treba i broj potrebnih
JLabel l6 = new JLabel ("Progres:\t",SwingConstants.LEFT);
JLabel l7 = new JLabel ("STOP kodon:\t",SwingConstants.LEFT);
JLabel l8 = new JLabel ("Sinonim br:\t",SwingConstants.LEFT);
...
public void doMutagen(){
		...
		JOptionPane.showMessageDialog(null,"Edit or copy the sequences!");
	...
	else if (n.isDNA(SEQ1) && n.isDNA(SEQ2)){
			if 	(SEQ1.length() == SEQ2.length() && (SEQ1.length()%3)==0 ){
				...
				do{
					...
					l4.setText ("Br pokušaja:\t" + vrObj.getBrPokusaja());
					l5.setText ("Br potrebnih:\t" + vrObj.getPotrebnihPromjena());
					...
					l8.setText ("Sinonim br:\t" + vrObj.getBrSinonims());
